      ...
      <div className="container mx-auto px-2 max-w-7xl">
        <button
          onClick={() => {
            ...
            trackEvent(newState ? 'section_expand' : 'section_collapse', 'forest_fire', 'toggle');
          }}
          className="w-full flex items-center justify-between mb-4 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-gray-900 rounded"
          aria-expanded={isExpanded}
          aria-controls="forest-fire-content"
        >
        ...
        {isExpanded && (
          <div id="forest-fire-content" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  <p className={colors.text}>
                    {index === 0 && 
                      <>
                       ...
                       (<a href="https://www.researchgate.net/publication/287243259_Fire_in_Mediterranean_Ecosystems_Ecology_Evolution_and_Management" target="_blank" rel="noopener noreferrer" className={colors.accent} onClick={() => trackEvent('research_link_click', 'forest_fire', 'Keeley et al., 2011')}>Keeley et al., 2011</a>).
                      </>
                    }
                    {index === 1 && 
                      <>
                        ...
                        (<a href="https://doi.org/10.1016/j.foreco.2005.01.018" target="_blank" rel="noopener noreferrer" className={colors.accent} onClick={() => trackEvent('research_link_click', 'forest_fire', 'Indigenous Fire Management')}>Indigenous Fire Management Practices</a>).
                      </>
                    }
                    {index === 2 && 
                      <>
                        ...
                        (<a href="https://doi.org/10.1073/pnas.1607171113" target="_blank" rel="noopener noreferrer" className={colors.accent} onClick={() => trackEvent('research_link_click', 'forest_fire', 'Abatzoglou & Williams, 2016')}>Abatzoglou & Williams, 2016</a>).
                      </>
                    }
                  </p>
                </CardContent>
